...
export class HelloWorldClient {
  ...
  readonly send = {
    ...
    doMath: async (params: CallParams<HelloWorldArgs['obj']['doMath(uint64,uint64,string)uint64'] | HelloWorldArgs['tuple']['doMath(uint64,uint64,string)uint64']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      ...
      return {...result, return: result.return as undefined | HelloWorldReturns['doMath(uint64,uint64,string)uint64']}
    },
